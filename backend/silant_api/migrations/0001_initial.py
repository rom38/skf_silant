# Generated by Django 4.2.3 on 2023-12-05 01:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='silant_api.machinemodel', verbose_name='Модель техники'),
        ),
        migrations.AddField(
            model_name='machine',
            name='maintenance_organization_fk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='silant_api.maintenanceorganization', verbose_name='Сервисная компания'),
        ),
        migrations.AddField(
            model_name='machine',
            name='steering_axel_model_fk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='silant_api.steeringaxelmodel', verbose_name='Модель управляемого'),
        ),
        migrations.AddField(
            model_name='machine',
            name='transmission_model_fk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='silant_api.transmissionmodel', verbose_name='Модель трансмиссии'),
        ),
        migrations.CreateModel(
            name='Complaint',
            fields=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('machine_fk', 'failure_date'), name='unique_fields_1'),
        ),
    ]
